        ...
        <div class="flex-grow-1">
            ...
            <form id="formMainMenu" action="" method="post">
                <div class="row row-cards">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <label class="form-label">Biodata Referensi</label>
                            <input type="text" class="form-control " name="biodata_ref_name" required>
        ...
        $('#table-data').on('click', '.btn-edit', function() {
            ...
            $.ajax({
                ...
                success: function(response, textStatus, xhr) {
                    ...
                    $('#formMainMenu [name="biodata_ref_name"]').val(data.biodata_ref_name);
