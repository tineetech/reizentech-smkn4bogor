            ...
            try {
                ...
                $.ajax({
                    ...
                    success: function(response, textStatus, xhr) {
                        ...
                        $('#formMainMenu [name="menu_code"]').val(data.menu_code);
                        $('#formMainMenu [name="menu_name"]').val(data.menu_name);
                        $('#formMainMenu [name="menu_type"]').val(data.menu_type).trigger('change');
                ...
                showAlert('danger', 'Gagal memuat data ' + error);
                $('#loadingSpinnerForm').hide();
                $('#offcanvasTop').offcanvas('hide');
            }
